...
import {originalGifs} from 'src/app//shared/gifs';

@Component({
  selector: 'app-gif-viewer',
  templateUrl: './gif-viewer.page.html',
  styleUrls: ['./gif-viewer.page.scss'],
})
export class GifViewerPage implements AfterViewInit {
